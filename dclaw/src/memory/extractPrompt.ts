...
export function buildMemoryExtractionPrompt(input: {
  ...
  return [
    ...
    '1. Read any existing files you may update, including MEMORY.md if you plan to change it.',
    ...
    '',
    '3. Update MEMORY.md as an index only. Each entry should stay short and point to the file. Never store full memory content directly in MEMORY.md.',
    '',

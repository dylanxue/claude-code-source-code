...
export function createAgentApp({ workspaceRoot = process.cwd(), resume = null, runtimeCallbacks = {} } = {}) {
  ...
  const systemPromptLines = [
    ...
    "When you are unsure which capability fits a task, use ToolSearch before guessing.",
    "When a task clearly maps to a local workflow or reusable procedure, consider loading a Skill before improvising the workflow from scratch.",
